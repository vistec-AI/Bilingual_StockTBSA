...
model (LLM), DeepSeek-R1-Distill-Llama-70B, on a Stock TBSA test set.
...
# -----------------------------
# NOTE:
# - This is the 6-shot hardcases prompt version in English.
# - A Thai version is available at: `Code/Prompt_Template/6-shot_LongPrompt_Hardcases_Thai.txt`
...
class Sentiment(BaseModel):
    sentiment: Literal["negative", "neutral", "positive", "exclude"] = Field(
        description="Select one sentiment label only for the target ticker."
    )
