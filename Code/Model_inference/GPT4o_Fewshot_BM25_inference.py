...
(e.g., GPT-4o) by retrieving similar examples from a BM25 retriever
...
# -----------------------------
DATASET_PATH = "./path/to/test_set.json"
FEWSHOT_SET_PATH = "./path/to/fewshot_dataset.json"
OUTPUT_JSON_PATH = "./path/to/output_predictions.jsonl"
RETRIEVED_DOCS_PATH = "./path/to/retrieved_docs.csv"
...
def create_prompts(queries: List[str], searched_docs: List[List[str]]):
    prompts = []
...
# -----------------------------
print("Preparing few-shot documents for BM25 retriever...")
